...
<head>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="keywords" content="讨饭网,没钱,贫穷,taofan，给点钱，穷啦，穷逼" />
	
	<meta name="description" content="让讨饭变得更简单" />
 ...
 <div class="mdui-container" style="max-width: 360px;">
    <div class="mdui-card" style="border-radius: 16px;">
        ...
        <center>Copyright © 2020 - <?php echo date('Y') ?> <a style='color:black' href='//tao.fan'>Tao.fan</a> All Rights Reserved.</center>
        </div>
    </div>
</div>
